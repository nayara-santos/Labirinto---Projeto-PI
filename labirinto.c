...
//Cores, definidas previamente como c�digo ANSI para facilitar a estiliza��o
...
int main(){
    ...
    if(resp==1 || resp==2 || resp==3){
        ...
        //Pedindo para o usu�rio selecionar o arquivo de labirinto a ser carregado
        ...
        //Printando o labirinto, utilizando os c�digos ANSI para deixar bonitinho
        for(i=0;i<m;i++){
            for(j=0;j<n;j++){
